...
var _time = function(){
      ...
      drawText("Time " + score + " secs", 4, '#FF4300', 400 - 160, 20);
...
var _starter = function(){
  ...
  var grd = ctx.createLinearGradient(120,0,300,0);
    ...
    var grd3 = ctx.createLinearGradient(150,0,600,0);
    grd3.addColorStop(0,"white");
    grd3.addColorStop(1,"#990000");
    ...
    drawText("Catch", 10, grd, 100, 150);
    drawText("The", 10, grd3, 170, 210);
    drawText("Fire", 10, grd2, 250, 270);
    ...
    drawText("Original version chiaho903 js13k2017", 3, 'rgba(255,255,255,0.5)', 28, 580);
    ...
    if(ig2 == 0){
        ...
        drawText("Press Enter to start", 4, 'rgba(255,255,255,0.5)', 167 - 80, HEIGHT / 3 * 2 + 100);
        drawText("Press Call to control audio", 3.225, 'rgba(255,255,255,0.5)', 167 - 80, HEIGHT / 3 * 2 + 75);
    }
...
var _describe = function(){
   ...
   for(var i in description){
    drawText(description[i], 3, '#4BB135', 170 - 80, i * 30 + 75);
   }

    drawText("Eat ", 3, '#fffc00', 120 - 80, 300);
    ctx.drawImage(foodImg, 0, 0, 20, 20, 162 - 80, 298, 20, 20);
    drawText("to gain light and Health point", 3, '#fffc00', 188 - 80, 300);

    drawText("Avoid ", 3, '#fffc00', 120 - 80, 345);
    ctx.drawImage(guardImg, 60, 0, 30, 30, 190 - 80, 335, 30, 30);
    drawText("to survive in the darkness ", 3, '#fffc00', 230 - 80, 345);

    drawText("move Control", 3, '#FFFFFF', 235 - 80, 430);
    drawText("W A S D", 4, '#FFFFFF', 140 - 80, 460);
    drawText("or", 3, '#FFFFFF', 288 - 80, 465);
    drawText("arrow key", 4, '#FFFFFF', 350 - 80, 460);


   if(ig2 == 0){
        drawText("Press enter to continue", 4, 'rgba(255,255,255,0.5)', 140 - 80, HEIGHT / 3 * 2 + 100);
    }
}
...
var _over = function(){
  ...
  var color = "#66cc33";
  drawText("Survived " + score + " secs in dreams", 4, color, 20, 200);
  drawText("Best survived: " + parseFloat(historyScore) + " secs", 4, color, 140 - 80, 300);
...
var _pause = function(){
  ...
  drawText("pause", 8, color, 240 - 80, 250);
  drawText("press 1 to continue", 4, color, 170 - 80, 350);
